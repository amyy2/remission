...
class _SleepTipsState extends State<SleepTipsPage> {
  final Uri _url = Uri.parse('https://www.ownyourcancercoaching.com/sleeptips');
        ...
        child: Column(
          children: [
            ...
            Container(
              padding: EdgeInsets.only(top: 16, left: 20, right: 20),
              width: double.infinity,
              child: const Text('Complete the following exercise:',
            ...
            GestureDetector(
              ...
              child: Container(
                ...
                width: double.infinity,
                child: const Text('Sleep tips exercise',
