        ...
        child: Column(
          children: [
            ...
            Container(
              padding: EdgeInsets.only(top: 16, left: 20, right: 20),
              width: double.infinity,
              child: const Text('What is your main goal in terms of physical activity? (ie., to get in shape, to be more active, to have more motivation to exercise, etc) Complete the following exercise.',
            ...
            GestureDetector(
              ...
              child: Container(
                ...
                width: double.infinity,
                child: const Text('SMART goals exercise',
